...
public class BenchMarkInserBorrInicio {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		long contador2 =1;
		t1 = System.nanoTime();
		//inserto 1 elemento en ArrayList al inicio 
		//y lo borro 100000
		...
		t2 = System.nanoTime();
		//inserto 1 elemento en LinkedList al inicio 
		//y lo borro 100000
		while (contador2<10000) {
			listaLink.add(0,1111);
			listaLink.remove(0);
			contador2++;		
		}//while	
		t3 = System.nanoTime();
